...
public class IngredientActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Response.Listener<String>responseListener = new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if(success=="True"){
                                AlertDialog.Builder builder = new AlertDialog.Builder(IngredientActivity2.this);
                ...
                RequestQueue queue = Volley.newRequestQueue(IngredientActivity2.this);
